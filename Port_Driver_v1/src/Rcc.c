...
// RCC Read Mask for AHB_Peri********************************************************************
#define 	RCC_APB2_PRE_READ			(uint32_t)(BIT_13 | BIT_14 | BIT_15)
...
/* Public Function:  Rcc_GetAPB2_Prescaler																	    *
 * Description: This function is used to Get APB2 Bus Prescaler.
 * Input parameters:
 *
 * Return:
 * 					- Status (uint8_t)
 ...
 *
 ****************************************************************************************************************/
uint8_t Rcc_GetAPB2_Prescaler(uint8_t *Rcc_APB2_Pre){

	uint32_t Loc_APB2_Pre = 0 ;
	RT_Debug Status = RT_SUCCESS ;

	if (Rcc_APB2_Pre != NULL)
	{
		Loc_APB2_Pre  = (Rcc -> CFGR & RCC_APB2_PRE_READ);
		switch(Loc_APB2_Pre)
		{
		case	RCC_APB2_PRE_2 :
			*Rcc_APB2_Pre = 2 ;
