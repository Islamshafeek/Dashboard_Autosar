...
#define _UBRRH          (*((  volatile tuniRegType  * ) 0x40 ) )
#define _UCSRC          (*((  volatile tuniRegType  * ) 0x40 ) )
#define _UDR            (*((  volatile tuniRegType  * ) 0x2C ) )
#define _UCSRA          (*((  volatile tuniRegType  * ) 0x2B ) )
#define _UCSRB          (*((  volatile tuniRegType  * ) 0x2A ) )
#define _UBRRL          (*((  volatile tuniRegType  * ) 0x29 ) )
